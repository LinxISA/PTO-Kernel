...
namespace pto {
  ...
  constexpr pipe_t opPipeList[] = {
    ...
    PIPE_V /* TROWSUM */, PIPE_V /* TROWMAX */, PIPE_V /* TROWMIN */, PIPE_V /* TROWEXPAND */, PIPE_V /* TCOLSUM */,
    PIPE_V /* TCOLMAX */, PIPE_V /* TCOLMIN */, PIPE_V /* TTRANS */, PIPE_V /* TTRI */, PIPE_V /* TREM */,
    PIPE_V /* TREMS */, PIPE_V /* TSUBS */, PIPE_V /* TMAXS */, PIPE_V /* TMOV_V2V */,
    ...
    PIPE_FIX /* TEXTRACT_A2M */, PIPE_FIX /* TINSERT_A2M */, PIPE_ALL /* OP_COUNT */,
  };
